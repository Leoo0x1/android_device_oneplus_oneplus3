...
$(KERNEL_OBJ)/usr:
	...
	prebuilts/build-tools/linux-x86/bin/make -C kernel/oneplus/msm8996 O=$(PWD)/$(KERNEL_OBJ) ARCH=arm64 CROSS_COMPILE=$(PWD)/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- headers_install INSTALL_HDR_PATH=$(PWD)/$(KERNEL_OBJ)/usr
