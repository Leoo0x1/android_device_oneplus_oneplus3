...
# Unofficial bring-up: bake the workstation adb key into /adb_keys so recovery
# adbd (ro.adb.secure=1) accepts our host without on-screen confirmation.
PRODUCT_ADB_KEYS := $(LOCAL_PATH)/keys/adbkey.pub
